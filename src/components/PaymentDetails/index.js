                                ...
                                <div className="card-body">
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-6">
                                            ...
                                            <input required id="checkout-phone" name="phoneNumber" onChange={(e) => setPhoneNumber(e.target.value)} value={phoneNumber} type="tel" placeholder="Phone" className="form-control" />
                                        </div>
                                    </div>
